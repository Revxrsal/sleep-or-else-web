    ...
    createEffect(() => {
        if (props.show()) {
            ...
            function focusTrap(e: KeyboardEvent) {
                ...
                if (isEscape) return props.setShow(true);
                if (shiftKey) {
                ...
                <section role="dialog" class="modal" ref={modal}>
                    <header>
                        ...
                        <button
                            ...
                            class="hover:bg-yellow-500 dark:hover:bg-yellow-700 group transition h-12 w-12 fill text justify-center items-center flex rounded"
                            onClick={() => close()}
                        >
                            {/*<IoClose size={24}/>*/}
                        </button>
